...
SELECT MAX(MARKS) FROM DATA1;
SELECT AVG(MARKS) FROM DATA1;
SELECT MIN(MARKS) FROM DATA1;
SELECT SUM(MARKS) FROM DATA1;
SELECT COUNT(ID) FROM DATA1;

SELECT CITY , StudentNAME, COUNT(ID) 
FROM DATA1
GROUP BY CITY , StudentNAME;
...
SELECT CITY , MAX(MARKS) FROM DATA1
GROUP BY CITY
HAVING MAX(MARKS) > 90;
